...
#---- actions
    ...
    def find_any_zone(self, game_state: GameState):
        def is_zone(pos: Pos):
            if game_state.map.tiles[pos.y][pos.x].zone:
                return True
            return False
        return self.search(game_state,is_zone)
...
# --- actions end
    ...
    def decide_action(self, game_state: GameState):
        return self.find_any_zone(game_state)
